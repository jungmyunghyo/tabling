...
function fn_place_set(tp, sz) {
	...
	if (tp == 1) {
		if (sz == 80) {
			...
			$("#text-container-add--" + 0).val("에어컨");
			fn_div_container_item_add(5, 0);
			$("#text-container-add--" + 0).val("스크린");
			fn_div_container_item_add(7, 0);
			$("#text-container-add--" + 0).val("냉장고");
			fn_div_container_item_add(5, 0);
			fn_div_container_add();
		...
		if (sz == 90) {
			...
			fn_div_container_item_add(5, 0);
			fn_div_container_add();
			$("#text-container-add--" + 1).val("스크린");
			fn_div_container_item_add(5, 1);
			fn_div_container_item_add(2, 1);
			fn_div_container_item_add(2, 1);
			fn_div_container_item_add(2, 1);
			$("#text-container-add--" + 1).val("일회용품");
			fn_div_container_item_add(5, 1);
			fn_div_container_add();
			fn_div_container_item_add(5, 2);
			$("#text-container-add--" + 2).val("냉장고");
			fn_div_container_item_add(3, 2);
			fn_div_container_item_add(5, 2);
			fn_div_container_item_add(1, 2);
			fn_div_container_item_add(1, 2);
			$("#text-container-add--" + 2).val("화장실");
		...
		if (sz == 14) {
			...
			fn_div_container_item_add(5, 0);
			fn_div_container_item_add(4, 0);
			$("#text-container-add--" + 0).val("모니터");
			fn_div_container_item_add(5, 0);
			fn_div_container_add();
			fn_div_container_item_add(5, 1);
			fn_div_container_item_add(3, 1);
			$("#text-container-add--" + 1).val("입구");
			fn_div_container_item_add(5, 1);
		}
	} else if (tp == 6) {
		if (sz == 60) {
		...
		if (sz == 60) {
			fn_div_container_add();
			$("#text-container-add--" + 0).val("창고");
			fn_div_container_item_add(5, 0);
			fn_div_container_item_add(5, 0);
			$("#text-container-add--" + 0).val("화장실");
			fn_div_container_item_add(6, 0);
			$("#text-container-add--" + 0).val("부스");
			fn_div_container_item_add(6, 0);
			$("#text-container-add--" + 0).val("입구");
			fn_div_container_item_add(5, 0);
			fn_div_container_add();
			$("#text-container-add--" + 1).val("스크린");
			fn_div_container_item_add(5, 1);
		...
		if (sz == 18) {
			fn_div_container_add();
			fn_div_container_item_add(7, 0);
			$("#text-container-add--" + 0).val("텐트");
			fn_div_container_item_add(6, 0);
			$("#text-container-add--" + 0).val("테라스");
			fn_div_container_item_add(7, 0);
			fn_div_container_add();
			$("#text-container-add--" + 1).val("주방");
			fn_div_container_item_add(5, 1);
			fn_div_container_item_add(3, 1);
			fn_div_container_item_add(3, 1);
			$("#text-container-add--" + 1).val("모니터");
			fn_div_container_item_add(5, 1);
		}
	} else if (tp == 10) {
		if (sz == 60) {
			fn_div_container_add();
			fn_div_container_item_add(5, 0);
			$("#text-container-add--" + 0).val("책장");
			fn_div_container_item_add(7, 0);
			$("#text-container-add--" + 0).val("입구");
			fn_div_container_item_add(6, 0);
			$("#text-container-add--" + 0).val("흡연장");
			fn_div_container_item_add(6, 0);
			fn_div_container_add();
			$("#text-container-add--" + 1).val("모니터");
			fn_div_container_item_add(5, 1);
		...
		if (sz == 80) {
			...
			fn_div_container_item_add(1, 1);
			fn_div_container_add();
			$("#text-container-add--" + 2).val("스크린");
			fn_div_container_item_add(5, 2);
			fn_div_container_item_add(1, 2);
			fn_div_container_item_add(1, 2);
			fn_div_container_add();
			$("#text-container-add--" + 3).val("입구");
			fn_div_container_item_add(5, 3);
			fn_div_container_item_add(1, 3);
			fn_div_container_item_add(1, 3);
		}
